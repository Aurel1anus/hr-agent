...
def candidate_view(c:Candidate): return {"id":c.id,"name":c.name,"phone":c.phone,"email":c.email,"school":c.school,"major":c.major,"highest_degree":c.highest_degree,"graduation_year":c.graduation_year,"current_city":c.current_city,"source":c.source,"resume_url":c.resume_url,"created_at":c.created_at,"updated_at":c.updated_at}
